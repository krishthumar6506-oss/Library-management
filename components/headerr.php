...
<nav class="navbar-custom">
    ...
    <div class="menu-items">
        ...
        <?php if (isset($_SESSION['student_id'])) { ?>
            ...
            <span class="but">
                <i class="fa-solid fa-user"></i> <span class="d-none d-md-inline">Welcome, <?php echo $_SESSION['student_name']; ?></span>
            </span>

            <a href="components/user_logout.php" class="but" onclick="return confirm('Logout from this website?');">
